...
final class SimpleCanonicalFieldsUpdater implements CanonicalFieldsUpdater
{
    private Canonicalizer $usernameCanonicalizer;

    private Canonicalizer $emailCanonicalizer;

    public function __construct(Canonicalizer $usernameCanonicalizer, Canonicalizer $emailCanonicalizer)
    {
